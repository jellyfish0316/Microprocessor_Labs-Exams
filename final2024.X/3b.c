...
void TMR3_Initialize(void){
    ...
    T1CONbits.T1CKPS = 0b01;  // Timer3 prescaler = 1:2 
...
void main() {
    ...
    while (1) {
        ...
        if(direction == 1){
            ...
            if(pattern == 0){
                set_LED_separately(1, 1, 1, 0);
                printf("LLL\n");
            }
            else if(pattern == 1){
                set_LED_separately(0, 1, 1, 0);
                printf("DLL\n");
            }
            else if(pattern == 2){
